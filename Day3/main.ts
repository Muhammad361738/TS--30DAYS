...
//  a number (e.g., `5`). Return their sum as a number.
 function arithematic (num1:string , num2 : number){
...
function multiPlyDecimal(num1 : number,num2 :number){
...
function reminderAndDivision (num1 : number, num2: number):{quotient : number ; reminder:number}{
