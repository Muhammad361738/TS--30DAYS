...
function replaceElement (myFruits : string[]){
    const index = myFruits.indexOf("Banana");
    if(index !==-1) myFruits[index] = "Mango"
}
let myFruits : string[]= ["Apple","Banana","orange", "Graphs"]
